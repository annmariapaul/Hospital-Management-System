...
const CustomAlert = ({ isOpen, title, message, type, onConfirm, onClose, onCancel }) => {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`relative bg-white p-6 rounded-xl w-96 border-t-8 shadow-xl ${borderColor}`}
      >
